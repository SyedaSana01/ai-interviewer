...
Upload resumes
Automatically shortlist candidates using AI
...
Matches resumes with Job Description (JD)
...
Job Description
Difficulty level
⏱ 1-Minute Interview Mode (Demo Ready)
...
AI → Shortlists Candidates
        ↓
Email → Sends Interview Link (/interview/{token})
        ↓
Candidate → Takes AI Interview (Proctored)
        ↓
AI → Evaluates Performance
        ↓
System → Generates Report + Hiring Decision
        ↓
...
AI Integration: NLP + LLM-based evaluation
...
ATS integrations
Live recruiter dashboard analytics
🤝 Contributing
